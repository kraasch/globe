...
//////////////////////////////////////////////////////////////
/////////////////////////////////// MISC MOON DATA PROVIDER //
//////////////////////////////////////////////////////////////

type MoonMiscDataProviderInterface interface {
	DataProviderInterface
	MiscMoonData() (float64, float64)
}
...
type XxxMoonMiscDataProvider struct {
	DataProvider
}

func (p XxxMoonMiscDataProvider) MiscMoonData() (float64, float64) {
